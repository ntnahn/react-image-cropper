...
var Cropper = function (_Component) {
    ...
    _createClass(Cropper, [{
        ...
        value: function calcPosition(width, height, left, top, callback) {
            ...
            if (top > this.props.maxImageHeight - height) {
                top = this.props.maxImageHeight - height;
            }
            if (left > this.props.maxImageWidth - width) {
                left = this.props.maxImageWidth - width;
            }
...
*/
var defaultStyles = {
    container: {maxHeight:600,maxWidth:600},
    img: {
        userDrag: 'none',
        userSelect: 'none',
        MozUserSelect: 'none',
